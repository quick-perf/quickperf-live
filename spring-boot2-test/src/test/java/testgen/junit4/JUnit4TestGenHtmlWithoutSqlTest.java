...
public class JUnit4TestGenHtmlWithoutSqlTest extends TestGen {

    @Test public void
    should_generate_a_junit4_test_for_html_return_and_withput_sql_execution() throws IOException {

        // GIVEN
        testGenerationConfig.setJunit4GenerationEnabled(true);

        String testRelativePath = "junit4" + File.separator + "html-without-sql";
