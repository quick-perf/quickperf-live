...
public class JUnit5TestGenTextWithoutSqlTest extends TestGen {

    @Test public void
    should_generate_a_junit5_test_for_text_return_without_sql_execution() throws IOException {

        // GIVEN
        testGenerationConfig.setJunit5GenerationEnabled(true);

        String testRelativeRelativePath = "junit5" + File.separator + "text-without-sql";
