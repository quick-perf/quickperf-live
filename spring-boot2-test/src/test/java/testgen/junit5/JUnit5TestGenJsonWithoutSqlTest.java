...
public class JUnit5TestGenJsonWithoutSqlTest extends TestGen {

    @Test public void
    should_generate_a_junit5_test_for_json_without_sql_execution() throws IOException {

        // GIVEN
        testGenerationConfig.setJunit5GenerationEnabled(true);

        String testRelativeRelativePath = "junit5" + File.separator + "json-without-sql";
