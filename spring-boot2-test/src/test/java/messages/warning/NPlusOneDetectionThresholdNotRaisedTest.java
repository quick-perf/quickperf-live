...
public class NPlusOneDetectionThresholdNotRaisedTest extends TestQuickPerfMessages {

    @Test public void
    should_not_suspect_an_n_plus_one_select_if_detection_threshold_not_raised() {

        databaseConfig.setNPlusOneSelectDetected(true);
        short nPlusOneSelectDetectionThreshold = 4;
