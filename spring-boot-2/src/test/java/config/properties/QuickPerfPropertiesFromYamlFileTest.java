...
public class QuickPerfPropertiesFromYamlFileTest {


    @Test public void
    should_initialize_jvm_config_from_a_yaml_file() {

        ApplicationContextRunner applicationContextRunner = new ApplicationContextRunner()
                .withInitializer(new ConfigFileApplicationContextInitializer())
                .withPropertyValues("spring.config.location=classpath:quickperf-properties-test.yml")
    ...
    @Test public void
    should_initialize_database_config_from_a_yaml_file() {
    ...
    @Test public void
    should_initialize_database_http_config_from_a_yaml_file() {
    ...
    @Test public void
    should_initialize_test_generation_config_from_a_yaml_file() {
